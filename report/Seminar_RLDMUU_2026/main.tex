...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/simple_MDP.png}
...
\IfFileExists{figures/policies_100Qlearn.png}{%
  \includegraphics[width=0.8\linewidth]{figures/policies_100Qlearn.png}
}{%
  \todofig{Place figures/policies\_100Qlearn.pn here.}
}

\vspace{0.5em}

\IfFileExists{figures/utilitydistr_100qlearn.png}{%
  \includegraphics[width=0.8\linewidth]{figures/utilitydistr_100qlearn.png}
}{%
  \todofig{Place figures/utilitydistr_100qlearn.png here.}
}
\vspace{0.5em}

\IfFileExists{figures/regretdistr_100qlearn.png}{%
  \includegraphics[width=0.8\linewidth]{figures/regretdistr_100qlearn.png}
}{%
  \todofig{Place figures/regretdistr_100qlearn.png here.}
}
\caption{Comparison between oracle and Q-learning}
\label{fig:single}
\end{figure}
